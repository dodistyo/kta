...
export type WidgetDomicileDistributionProps = Omit<
...
> & {
  ...
  /** @default "Sebaran Domisili" */
  title?: string;
};

const WidgetDomicileDistribution: React.FC<WidgetDomicileDistributionProps> = props => {
  const theme = useTheme<Theme>();
  const { data, elevation = 'container', title = 'Sebaran Domisili', ...rest } = props;
...
export default WidgetDomicileDistribution;
